...
import eg.esperantgada.roommultipletables.adapter.SchoolAdapter
import eg.esperantgada.roommultipletables.databinding.FragmentSchoolListBinding
...
class SchoolListFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        _binding = FragmentSchoolListBinding.inflate(inflater)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        lifecycleScope.launchWhenCreated {
            allItemsViewModel.schools.collectLatest {
        ...
        searchView.setOnQueryTextListener(object : SearchView.OnQueryTextListener{
            override fun onQueryTextSubmit(query: String?): Boolean {
                if (query != null){
                    ...
                    sortedItemsViewModel.sortedSchoolList.observe(viewLifecycleOwner){
                        adapter.submitData(viewLifecycleOwner.lifecycle, it)
                    }
